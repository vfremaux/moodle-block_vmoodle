 ...
 */
class Vmoodle_Command_Maintenance extends Vmoodle_Command {	
	...
	public function __construct($name, $description, $parameters=null, $rpcommand=null) {
		...
		if (is_null($parameters) or is_array($parameters)){
			throw new Vmoodle_Command_Maintenance_Exception('messageparamonly');
		}
	...
	public function run($hosts) {
		...
		if (!has_capability('block/vmoodle:execute', get_context_instance(CONTEXT_SYSTEM)))
			throw new Vmoodle_Command_Maintenance_Exception('insuffisantcapabilities');
