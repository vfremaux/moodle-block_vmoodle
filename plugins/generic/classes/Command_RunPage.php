...
class Command_RunPage extends Command {
    ...
    public function __construct($name, $description, $parameters = null, $rpcommand = null) {
        ...
        foreach ($parameters as $param) {
            $pname = $param->getName();
            if (!in_array($pname, array('pageurl', 'params', 'httpmode'))) {
                throw new \coding_exception('RunPage : Parameter name ('.$pname.') is not in expected namelist. Check plugin configuration file.');
            }
        }
    }
