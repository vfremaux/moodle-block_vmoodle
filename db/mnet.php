...
$subscribes = array(
    'mnetadmin' => array(
        'mnetadmin_rpc_bind_peer' => 'blocks/vmoodle/rpclib.php/mnetadmin_rpc_bind_peer',
        'mnetadmin_rpc_unbind_peer' => 'blocks/vmoodle/rpclib.php/mnetadmin_rpc_unbind_peer',
    ),
);
