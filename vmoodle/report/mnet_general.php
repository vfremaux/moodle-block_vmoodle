<?php
	...
	echo $OUTPUT->heading(get_string('cnxs', 'block_vmoodle'));

	if (function_exists('local_print_static_text'))
		local_print_static_text('static_vmoodle_report_general', $CFG->wwwroot.'/blocks/vmoodle/report/view.php');
	...
	echo $OUTPUT->heading(get_string('totalcnxs', 'block_vmoodle'));
