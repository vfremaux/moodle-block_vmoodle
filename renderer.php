...
class block_vmoodle_renderer extends plugin_renderer_base {
    ...
    public function status() {
        ...
        if ($vmoodles) {
            ...
            foreach($vmoodles as $vmoodle) {
                $str .= '<tr>';
                $str .= '<td>';
                $str .= '<a href="'.$vmoodle->vhostname.'" target="_blank">'.$vmoodle->shortname.' - '.$vmoodle->name.'</a></td>';
                $str .= '<td>'.$this->host_status($vmoodle).'</td>';
                $str .= '</tr>';
            }
            $str .= '</table>';
        }
     ...
     */
    public function host_status($vmoodle) {
        global $OUTPUT;
        ...
        if (!vmoodle_check_installed($vmoodle)) {
            ...
            $pix = '<img src="'.$OUTPUT->pix_url('enabled', 'block_vmoodle').'" />';
            ...
            $pix = '<img src="'.$OUTPUT->pix_url('disabled', 'block_vmoodle').'" />';
