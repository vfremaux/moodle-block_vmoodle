    ...
    public function get_content() {
        ...
        if (isloggedin()) {
            if (has_capability('local/vmoodle:managevmoodles', $context)) {
                $vmoodleurl = new moodle_url('/local/vmoodle/view.php');
                $this->content->footer = '<a href="'.$vmoodleurl.'">'.get_string('administrate', 'block_vmoodle').'</a><br/>';
                $this->content->text = $renderer->print_status();
            } else {
