<?php
	...
	echo $OUTPUT->heading(get_string('users', 'block_vmoodle'));

	if (function_exists('local_print_static_text'))
		local_print_static_text('static_vmoodle_report_users', $CFG->wwwroot.'/blocks/vmoodle/report/view.php?view=users');
